...
class Clause(object):
    ...
    def evaluate(self, FuzzySystem, verbose=True, operators=None):
        try:
    ...
    if regex_clause.match(text):
        ...
        try:
            novel_fun = Functional(operator,
                                   recursive_parse(firsthalf, verbose=verbose, operators=operators,
                                                   allow_empty=allow_empty),
                                   recursive_parse(secondhalf, verbose=verbose, operators=operators,
                                                   allow_empty=allow_empty),
                                   operators=operators)
        except:
            raise Exception("ERROR: badly formatted rule, please check capitalization and syntax.\n"
